...
const instruments = List([PianoInstrument, tdwlop, anliao2Instrument, elyssamari]);
const visualizers = List([WaveformVisualizer, WaveformVisualizer2, anliao2Visualizer, elyssamariVisualizer]);
